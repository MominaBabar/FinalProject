...
class MapScreen extends React.Component {
  constructor(props){
    super(props);
    // this.socket = io("http://192.168.18.63:5090", {transports: ['websocket']});
    // this.socket.on('connection',(socket)=>{
    //   console.log("jjjj")
    // })
    this.socket = socketIO('ws://192.168.18.63:5090', {      
  ...
  componentDidMount() { 
    // const socket = socketIO('http://192.168.18.63:5090', {      
    // transports: ['websocket'], jsonp: false });   
    // socket.connect(); 
    // socket.on('connect', () => { 
    //   console.log('connected to socket server'); 
